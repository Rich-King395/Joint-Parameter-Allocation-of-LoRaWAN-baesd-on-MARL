...
def MACMAB_run(nodes):
    ...
    plot("/home/uestc/LoRaSimulator/Joint-Parameter-Allocation-of-LoRaWAN-baesd-on-MARL/MACMAB_SF/results")
...
def MACMAB_train(nodes, episode):
    ...
    for node in nodes:
        ...
        # node.agent.reward_SF = node.PDR + reward_towards_fair_sf + reward_towards_small_SF
        node.agent.reward_SF = node.PDR + reward_towards_small_SF
