...
class DLoRa:
    ...
    def Expected_Reward_Update(self,k_sf,k_bw,k_fre,k_tp):
        ...
        # self.rewards[3] = self.rewards[3] - float(ParameterConfig.Transmission_Power[k_tp]/TP_SUM)*3.5
...
""" epsilon greedy algorithm, inherit from DLoRa """
class EpsilonGreedy(DLoRa):
    def __init__(self):
        super(EpsilonGreedy, self).__init__()
        self.epsilon = DLoRa_Config.epsilon
...
""" time-decreasing epsilon-greedy algorithm, inherit from DLoRa"""
class DecayingEpsilonGreedy(DLoRa):
    def __init__(self):
        super(DecayingEpsilonGreedy, self).__init__()
        self.epsilon = DLoRa_Config.decay_epsilon
