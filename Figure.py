...
#     'DLoRa-Balance': [90.91, 89.83, 88.30, 85.81, 80.14],
#     'DLoRa-PDR': [95.30, 92.14, 89.46, 86.70, 79.66],
#     'DLoRa-EE': [84.14, 80.89, 78.73, 79.07, 74.86],
#     'DLoRa-Throughput': [89.91, 83.68, 74.99, 77.65, 72.86]
...
#     'DLoRa-Balance': [84.216, 39.6, 22.328, 21.048, 12.96],
#     'DLoRa-PDR': [25.673, 23.469, 21.318, 17.253, 13.450],
#     'DLoRa-EE': [125.187, 50.790, 37.688, 23.146, 14.760],
#     'DLoRa-Throughput': [36.688, 26.077, 17.466, 8.863, 8.064]
...
#     'DLoRa-Balance': [573.615, 551.314, 490.888, 461.912, 304.005],
#     'DLoRa-PDR': [617.031, 552.995, 535.476, 432.262, 335.355],
#     'DLoRa-EE': [412.128, 357.050, 381.230, 347.664, 291.953],
#     'DLoRa-Throughput': [887.723, 652.130, 428.261, 220.658, 201.981]
...
radius_node_300_pdr_data = {
    ...
    'DLoRa': [90.91, 89.83, 88.30, 85.81, 27.96]
}
...
radius_node_300_NetEE_data = {
    ...
    'DLoRa': [10.527, 4.950, 2.791, 2.631, 9.819]
}
...
radius_node_300_Throughput_data = {
    ...
    'DLoRa': [573.615, 551.314, 490.888, 461.912, 155.269]
}
...
#     'DLoRa': [2.422, 2.341, 2.279, 2.374, 2.220]
# }
...
num_pdr_data = {
    ...
    'DLoRa': [89.83, 81.82, 71.23, 57.24, 47.80]
}
...
num_NetEE_data = {
    ...
    'DLoRa': [4.950, 3.743, 4.060, 3.250, 2.334]
}
...
num_Throughput_data = {
    ...
    'DLoRa': [551.314, 539.236, 524.298, 415.546, 324.623]
}
...
#     'DLoRa': [2.341, 2.335, 2.579, 2.526, 2.590]
# }
